...
class Quiz extends Component{
  ...
  playGame() {
    ...
    if (this.state && this.state.gameOver && this.state.correct){
  ...
  renderMessage(){
    if (this.state.correct)
      return <h3>Right Answer ! Hit the below button to play again</h3>
    else
      return <h3>Oops wrong answer ! Hit the below button to play again</h3>
  }
  ...
  render(){
    return(
      <div className="quiz">
        ...
        <div className={classNames('after',{'hide' : !this.state.gameOver}, {'wrong animated rotateInDownLeft ' : !this.state.correct}, {'correct animated backInDown' : this.state.correct})}>
          {this.renderMessage()}
        </div>
